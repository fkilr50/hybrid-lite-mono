...
"Branch F validation sweep started $(Get-Date -Format s)" | Tee-Object -FilePath $SweepLog
...
"Branch F checkpoint sweep finished $(Get-Date -Format s)" | Tee-Object -FilePath $SweepLog -Append
