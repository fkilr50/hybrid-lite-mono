...
& $PythonRunner run -n lite-mono python `
  ...
  --output_dir "$VisualDir/baseline_vs_plain_2ep_val" `
  --baseline_name "Plain Citrus final" `
  --phase2_name "Plain Citrus 2ep control"
...
& $PythonRunner run -n lite-mono python `
  ...
  --phase2_results_dir $ResultsDir `
  --phase2_weights $WeightsFolder `
  --output_dir "$VisualDir/baseline_vs_plain_2ep_test" `
  --baseline_name "Plain Citrus final" `
  --phase2_name "Plain Citrus 2ep control"
