...
class LiteMonoOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--lidar_loss_min_valid_pixels",
                                 ...
                                 default=500)
        self.parser.add_argument("--original_prior_weight",
                                 type=float,
                                 help="Branch G frozen-original prior weight on LiDAR-invalid pixels; 0 disables it",
                                 default=0.0)
        self.parser.add_argument("--original_prior_weights_folder",
                                 type=str,
                                 help="weights folder for the frozen original Lite-Mono teacher",
                                 default="weights/lite-mono")
        self.parser.add_argument("--original_prior_scales",
                                 nargs="+",
                                 type=int,
                                 help="scales where the frozen-original normalized-disparity prior is applied",
                                 default=[0])
        self.parser.add_argument("--original_prior_min_valid_pixels",
                                 type=int,
                                 help="minimum active LiDAR-invalid pixels needed to apply original-prior loss",
                                 default=500)
        self.parser.add_argument("--original_prior_require_lidar_invalid",
                                 help="apply frozen-original prior only where the LiDAR label mask is invalid",
                                 action="store_true")
