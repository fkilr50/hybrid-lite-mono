...
$RunName = "branch_b_lidar_only_from_w13_b12_2ep_s001_laptop"
...
& $Python citrus_project/milestones/04_lightweight_vegetation_improvement/Marvel/compare_phase2_visuals.py `
  ...
  --output_dir "$VisualDir/branch_a_w13_vs_branch_b_val" `
  --baseline_name "Branch A w13" `
  --phase2_name "Branch B 2ep" 2>&1 | Tee-Object -FilePath $PostprocessLog -Append
...
& $Python citrus_project/milestones/04_lightweight_vegetation_improvement/Marvel/compare_phase2_visuals.py `
  ...
  --baseline_weights $BaseWeights `
  --phase2_weights $WeightsFolder `
  --output_dir "$VisualDir/branch_a_w13_vs_branch_b_test" `
  --baseline_name "Branch A w13" `
  --phase2_name "Branch B 2ep" 2>&1 | Tee-Object -FilePath $PostprocessLog -Append
